...
//
//   Cuentos infantiles (12: 9 terremotos + 3 duelo) · Material para padres (11: 6 terremotos + 5 duelo) · Materiales para psicólogos y afines (6) = 29
//
const resources = [
  ...
  { id: 29, title: 'No es Fácil, Pequeña Ardilla', description: 'Cuento para acompañar a las niñas y niños en el duelo y la expresión de la tristeza.', category: 'Cuentos infantiles', subcategory: 'Sobre el duelo y la muerte', type: 'PDF', url: './Material terremoto niños/Cuentos infantiles/Sobre el duelo y la muerte/CUENTO-No-es-facil-pequena-ardilla.pdf' },

  // === Material para padres · Sobre terremotos ===
  { id: 6, title: 'Respondiendo a las Necesidades Emocionales de los Niños', description: 'Guía de la AAP y CHLA para padres y cuidadores tras una emergencia.', category: 'Material para padres', subcategory: 'Sobre terremotos', type: 'Guía Escrita', url: './Material terremoto niños/Material para padres/Sobre terremotos/CHLA-AAP-Responding-to-Childrens-Emotional-Needs-Spanish_0.pdf' },
  { id: 7, title: 'Reacciones a Eventos Traumáticos según la Edad', description: 'Cómo responden los menores ante el trauma según su etapa de desarrollo.', category: 'Material para padres', subcategory: 'Sobre terremotos', type: 'PDF', url: './Material terremoto niños/Material para padres/Sobre terremotos/age_related_reactions_to_traumatic_events_sp.pdf' },
  { id: 12, title: 'Ayudando a los Padres a Sobrellevar el Desastre (en inglés)', description: 'Folleto de CHLA y CDC con recursos básicos de manejo del estrés. Documento en inglés.', category: 'Material para padres', subcategory: 'Sobre terremotos', type: 'PDF', url: './Material terremoto niños/Material para padres/Sobre terremotos/inglés CHLA-CDC-Helping-Parents-Cope-with-Disaster-English.pdf' },
  { id: 14, title: 'Actividades Simples para Niños y Adolescentes', description: 'Dinámicas prácticas para hacer en casa y reducir la tensión y el estrés.', category: 'Material para padres', subcategory: 'Sobre terremotos', type: 'Actividad Práctica', url: './Material terremoto niños/Material para padres/Sobre terremotos/simple_activities_for_children_and_adolescents_spanish.pdf' },
  { id: 15, title: '12 Conceptos Básicos sobre el Estrés Traumático', description: 'Marco teórico para entender el comportamiento de la familia ante el trauma.', category: 'Material para padres', subcategory: 'Sobre terremotos', type: 'PDF', url: './Material terremoto niños/Material para padres/Sobre terremotos/the_12_core_concepts_for_understanding_traumatic_stress_responses_in_children_and_families_sp.pdf' },
  { id: 21, title: 'Guía Familiar ante Sismos y Maremotos', description: 'Recomendaciones prácticas de preparación y respuesta para toda la familia ante sismos y maremotos.', category: 'Material para padres', subcategory: 'Sobre terremotos', type: 'Guía Escrita', url: './Material terremoto niños/Material para padres/Sobre terremotos/guia-familiar-sismos-maremotos.pdf' },

  // === Material para padres · Sobre muerte y duelo ===
  { id: 8, title: 'Duelo Traumático en la Infancia (Resumen)', description: 'Conceptos fundamentales sobre el duelo en la edad pediátrica tras un desastre.', category: 'Material para padres', subcategory: 'Sobre muerte y duelo', type: 'Guía Escrita', url: './Material terremoto niños/Material para padres/Sobre muerte y duelo/brief_information_on_childhood_traumatic_grief_sp.pdf' },
  { id: 9, title: 'Duelo Traumático: Guía Completa para Padres', description: 'Guía extendida con recomendaciones para acompañar a los hijos en el duelo.', category: 'Material para padres', subcategory: 'Sobre muerte y duelo', type: 'PDF', url: './Material terremoto niños/Material para padres/Sobre muerte y duelo/childhood_traumatic_grief_materials_parents_sp.pdf' },
  { id: 10, title: 'Cómo Acompañar ante una Muerte no Confirmada', description: 'Apoyo para familias con menores en situaciones de personas desaparecidas.', category: 'Material para padres', subcategory: 'Sobre muerte y duelo', type: 'Guía Escrita', url: './Material terremoto niños/Material para padres/Sobre muerte y duelo/coping-with-unconfirmed-death-for-forcibly-displaced-children-and-families-caregivers-sp_0.pdf' },
  { id: 11, title: 'Ayudando a Adolescentes con Duelo Traumático', description: 'Estrategias específicas para acompañar a jóvenes que atraviesan un duelo.', category: 'Material para padres', subcategory: 'Sobre muerte y duelo', type: 'PDF', url: './Material terremoto niños/Material para padres/Sobre muerte y duelo/helping-teens-with-traumatic-grief-for-caregivers-sp.pdf' },
  { id: 13, title: 'Plan para Manejar los Recuerdos del Evento', description: 'Pasos prácticos para enfrentar los detonantes y los recuerdos intrusivos.', category: 'Material para padres', subcategory: 'Sobre muerte y duelo', type: 'Guía Escrita', url: './Material terremoto niños/Material para padres/Sobre muerte y duelo/making_a_plan_dealing_with_things_that_remind_you_what_happened_sp.pdf' },
